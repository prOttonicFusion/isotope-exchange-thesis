...
tTH_isoEx_400K = readData(path+'disloc_isoEx_400K_1500ns/HinDisl.out', [0,1,2])
tT_diff_400K = readData(path+'disloc_isoEx_400K_0H_1500ns/HinDisl.out', [0,1])
...
plt.text(50, 117, '(iii) 700 K', font)
