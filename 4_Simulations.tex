...
At 700 K, however, the simulations where continued to 1000 ns for each defect type, allowing us to compare the T-removal rates for not only the isotope exchange versus monoisotopic cases, but across defect types.   
