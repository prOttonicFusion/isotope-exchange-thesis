...
Finally, all sets of isotope exchange and monoisotope simulations were run at 400, 500 and 700 K, to qualitatively study the temperature dependence of the phenomenon.
To allow for shorter wall-times, the simulations at 400 and 500 K where cut off when all T had been detrapped in the isotope exchange case.
At 700 K, however, complete detrapping was required to occur also for the monoisotopic cases, allowing us to compare the T-removal rates for not only the isotope exchange versus monoisotopic cases, but between different defect types.   
