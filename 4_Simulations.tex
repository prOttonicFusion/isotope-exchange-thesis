...
% ---------------------------------------------------------------------------------------------------
In the dislocation case, a  $109.0 \times 136.8 \times 18.4$ $\AA^3$ simulation cell containing a 1/2\hkl[1 1 1]\hkl{1 0 0} edge dislocation was used. 
...
The cell was then divided into three equally thick slices, parallel to the \hkl{11-2} plane and a dislocation introduced through the addition of a \hkl{1 1 1} atom plane to the middlemost slice, as shown in \ref{Fig:disloc_construction}. 
