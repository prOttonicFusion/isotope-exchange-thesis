...
\begin{subfigure}{.48\textwidth}
	...
	\caption{\footnotesize{Comparision of the H-W binding energy in MD using the EAM1 potential by Bonny \textit{et. al} and DFT results by Heinola \textit{et. al. }\cite{heinolaTungstenDFT}}}
...
\begin{subfigure}{.48\textwidth}
	...
	\caption{\footnotesize{The potential energies of all individual T atoms in a 500 K simulation.\vspace*{6mm}}}
	\label{Fig:Epot}
  %\label{fig:sub-second}
\end{subfigure}
\end{figure}
