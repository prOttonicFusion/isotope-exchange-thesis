...
It is evident that the addition of T significantly increases the rate of T removal from both mono- and divacancies. 
...
\begin{subfigure}{.48\textwidth}
	...
	\caption{The potential energies of all individual T atoms in the 500 K simulation.\vspace*{6mm}}
	\label{Fig:Epot}
  %\label{fig:sub-second}
\end{subfigure}
\end{figure}
