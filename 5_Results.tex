...
We can see that at all three temperatures, tritium-removal occurs at a higher rate when isotope exchange is involved, compared to the monoisotopic cases.
...
For the divacancies, in Fig. \ref{Fig:2Vac_results}, the T-removal using isotope exchange in the occurs about as quickly as in the monovacancy case, despite starting with nearly twice the amount T. 
...
Compared to DFT \cite{heinolaTungstenDFT}, the EAM potential used in this work gives slightly lower binding energies for the hydrogen-vacancy interaction (Fig. \ref{Fig:Ebind1H_DFT}). 
